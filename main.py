...
def home():
  ...
  if water == False:
    flag, flag_meaning = info_country(country)
  else:
  ...
  return render_template("index.html", lat=lat, lon=lon, map=map, temp=temp, description=description,country=country, flag=flag, flag_meaning=flag_meaning, dist=dist)
